...
import kotlinx.android.synthetic.main.dialog_register_success.view.*
...
class RegisterDialog : DialogFragment() {
    ...
    companion object {
        ...
        fun showDialog(fragmentManager: FragmentManager): RegisterDialog {
            val receiveDialog = RegisterDialog()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val view = LayoutInflater.from(activity).inflate(R.layout.dialog_register_success, container, false)
